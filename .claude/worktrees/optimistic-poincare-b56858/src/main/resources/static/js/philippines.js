function loadProvinces(elementId) {
    let provinceDrowndown = document.getElementById(elementId);
    provinceDrowndown.innerHTML = '';

    let defaultopt = document.createElement('option');
    defaultopt.innerHTML = '-- Select Province --';
    provinceDrowndown.appendChild(defaultopt);

    provinces.forEach(province => {
        let opt = document.createElement('option');
        opt.value = province.key;
        opt.innerHTML = province.name
        provinceDrowndown.appendChild(opt);
    });
    provinceDrowndown.options[0].disabled = true;
    provinceDrowndown.selectedIndex = 0;
}
...
function loadCities(elementId, province) {
    ...
    let defaultopt = document.createElement('option');
    defaultopt.innerHTML = '-- Select City --';
    cityDropdown.appendChild(defaultopt);
    ...
    cityDropdown.options[0].disabled = true;
