...
public class WorkExperienceController {
	...
	@PostMapping("/deleteWorkExperience/{id}")
	@Transactional
	public String deleteWorkExperience(
		...
		String redirectBase = "redirect:/employee/work-experience/" + employeeId + "/" + (showMode == null ? "" : showMode) + "/" + empHashCode;

		Optional<WorkExperience> recordOptional = workExperienceRepository.findById(id);
		...
		workExperienceRepository.delete(recordOptional.get());
